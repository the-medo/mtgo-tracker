...
export default function TermsOfService() {
  return (
    <>
      ...
      <p className={`font-bold text-xl text-inherit ${displayFont.className} text-default-800`}>
      ...
      <p>
        <div className={`font-bold text-xl text-inherit ${displayFont.className} text-default-800`}>
